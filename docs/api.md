...
Upload files into an active conversation.
...
⚠️ Important: This endpoint requires multipart/form-data, even when no files are uploaded.
...
/chat must use multipart/form-data
